...
import com.merenda.merenda.api.users.User;
import com.merenda.merenda.api.users.UserDTO;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            com.merenda.merenda.api.infra.security.jwt.JwtLoginInput login = new ObjectMapper().readValue(request.getInputStream(), JwtLoginInput.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        String jwtToken = com.merenda.merenda.api.infra.security.jwt.JwtUtil.createToken(user);

//        String json = ServletUtil.getJson("token", jwtToken);
        String json = UserDTO.create(user, jwtToken).toJson();
        com.merenda.merenda.api.infra.security.jwt.ServletUtil.write(response, HttpStatus.OK, json);
    }
